...
function sass() {
  return gulp.src('web/resources/scss/app.scss')
...
function images() {
  return gulp.src('web/resources/img/**/*')
...
function watch() {
  ...
  gulp.watch('web/resources/scss/**/*.scss', sass);
  gulp.watch('web/resources/js/**/*.js', gulp.series(javascript, browser.reload));
  gulp.watch('web/resources/img/**/*', gulp.series(images, browser.reload));
